...
def main():
    ...
    # better_draw_circles(rg.Point(100, 50), radii_1)
    # better_draw_circles(rg.Point(-200, 0), radii_2)

    even_better_draw_circles(rg.Point(100, 50), radii_1, circles1, pen_color1, pen_thickness1)
    even_better_draw_circles(rg.Point(-200, 0), radii_2, circles2, pen_color2, pen_thickness2)
...
def even_better_draw_circles(point, radii, circles, pen_color, pen_thickness):
